        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Finalization Tasks</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <table class="table table-hover" id="myTable">
                  ...
                  <tbody id="tasks">
                   @foreach($tasks as $task)
                    ...
                    <td> 
                      <a href="{{route('management.task-finalization', $task['id'])}}"> 
                       <button type="buton" class="btn btn-success"> View Finalization </button>
                       </a>       
                     </td>
                     </tr>
                   @endforeach
