        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Invoices Payment</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="card-header">
                ...
                <div class="card-tools form-group float-right row" style="">
                  ...
                  <select onchange="window.location.href=this.value;" class="browser-default custom-select" id="invoice_status" style="width:150px;">
                   <option id="Approved" value="{{ route('management.view-allReadyToPayInvoices', 'Approved') }} "> Approved </option>
                   <option id="Paid" value="{{ route('management.view-allReadyToPayInvoices', 'Paid') }}"> Paid </option>
                ...
                <table class="table table-hover" id="myTable">
                  ...
                  <tbody id="invoices">
                   @foreach($invoices as $invoice)
                    ...
                    <td> 
                      <a href="{{route('management.view-paymentInvoice', $invoice['id'])}}"> 
