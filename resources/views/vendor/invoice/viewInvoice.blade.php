            ...
            @if(count($invoice->vendorWorkInvoiceItem))
             ...
             <div class="card card-info">
                ...
                <table class="table table-striped " id="">
                    ...
                    <tr>
                            <td> 
@if(App\WO::find(App\projectStage::find($invoiceItem->stageId)->wo_id)->client){{str_pad(App\WO::find(App\projectStage::find($invoiceItem->stageId)->wo_id)->client->code, 4, "0", STR_PAD_LEFT )}}@endif -{{str_pad(App\projectStage::find($invoiceItem->stageId)->wo_id, 4, "0", STR_PAD_LEFT )}}-{{str_pad(App\projectStage::find($invoiceItem->stageId)->project_id, 4, "0", STR_PAD_LEFT )}}
