                                     ...
                                     'delivery'=>$deliver_withFiles->thisVendor_delivery[$source_file->id][0]->id])}}" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                      ...
                                                      <div class="custom-file ">
                                                        <input type="file" class="custom-file-input" id="reference_files" name="delivery_file{{$stage->id}}" >
                                            ...
                                            <form id="deliveryForm" action="{{route('vendor.send-delivery',['stage'=> $stage->id,
                                             ...
                                             <div class="form-group">
                                                  ...
                                                  <div class="custom-file ">
                                                    <input type="file" class="custom-file-input" id="reference_files" name="delivery_file{{$stage->id}}" required>
                                                    <label class="custom-file-label" for="customFile">Choose file</label>
                                                  </div>
                                                </div>
                                        <button type="submit" class="btn btn-primary" > 
